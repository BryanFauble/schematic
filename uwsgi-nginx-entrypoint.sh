...
if [ -f /app/nginx.conf ]; then
    ...
    content_server=$content_server'        proxy_read_timeout 1200;\n'
    content_server=$content_server'        proxy_connect_timeout 1200;\n'
    content_server=$content_server'        proxy_send_timeout 1200;\n'
